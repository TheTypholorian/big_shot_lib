...
enum class ShaderVariableType(
    ...
    fun expectedTextureType(): GlTextureResourceType {
        return when (this) {
            SAMPLER_1D, INT_SAMPLER_1D, UINT_SAMPLER_1D, SAMPLER_1D_SHADOW,
            IMAGE_1D, INT_IMAGE_1D, UNSIGNED_INT_IMAGE_1D -> GlTextureResourceType.TEXTURE_1D

            SAMPLER_1D_ARRAY, INT_SAMPLER_1D_ARRAY, UINT_SAMPLER_1D_ARRAY, SAMPLER_1D_ARRAY_SHADOW,
            IMAGE_1D_ARRAY, INT_IMAGE_1D_ARRAY, UNSIGNED_INT_IMAGE_1D_ARRAY -> GlTextureResourceType.TEXTURE_1D_ARRAY

            SAMPLER_2D, INT_SAMPLER_2D, UINT_SAMPLER_2D, SAMPLER_2D_SHADOW,
            IMAGE_2D, INT_IMAGE_2D, UNSIGNED_INT_IMAGE_2D -> GlTextureResourceType.TEXTURE_2D

            SAMPLER_2D_ARRAY, INT_SAMPLER_2D_ARRAY, UINT_SAMPLER_2D_ARRAY, SAMPLER_2D_ARRAY_SHADOW,
            IMAGE_2D_ARRAY, INT_IMAGE_2D_ARRAY, UNSIGNED_INT_IMAGE_2D_ARRAY -> GlTextureResourceType.TEXTURE_2D_ARRAY

            SAMPLER_2D_RECT, INT_SAMPLER_2D_RECT, UINT_SAMPLER_2D_RECT, SAMPLER_2D_RECT_SHADOW,
            IMAGE_2D_RECT, INT_IMAGE_2D_RECT, UNSIGNED_INT_IMAGE_2D_RECT -> GlTextureResourceType.TEXTURE_RECTANGLE

            SAMPLER_3D, INT_SAMPLER_3D, UINT_SAMPLER_3D,
            IMAGE_3D, INT_IMAGE_3D, UNSIGNED_INT_IMAGE_3D -> GlTextureResourceType.TEXTURE_3D

            SAMPLER_CUBE, SAMPLER_CUBE_SHADOW,
            IMAGE_CUBE, INT_IMAGE_CUBE, UNSIGNED_INT_IMAGE_CUBE,
            INT_SAMPLER_CUBE, UINT_SAMPLER_CUBE -> GlTextureResourceType.TEXTURE_CUBE_MAP
            ...
            INT_SAMPLER_CUBE_MAP_ARRAY, UINT_SAMPLER_CUBE_MAP_ARRAY -> GlTextureResourceType.TEXTURE_CUBE_MAP_ARRAY

            SAMPLER_2D_MULTISAMPLE, IMAGE_2D_MULTISAMPLE,
            INT_IMAGE_2D_MULTISAMPLE, UNSIGNED_INT_IMAGE_2D_MULTISAMPLE,
            INT_SAMPLER_2D_MULTISAMPLE, UINT_SAMPLER_2D_MULTISAMPLE -> GlTextureResourceType.TEXTURE_2D_MULTISAMPLE
            ...
            INT_SAMPLER_2D_MULTISAMPLE_ARRAY, UINT_SAMPLER_2D_MULTISAMPLE_ARRAY -> GlTextureResourceType.TEXTURE_2D_MULTISAMPLE_ARRAY

            SAMPLER_BUFFER, INT_SAMPLER_BUFFER, UINT_SAMPLER_BUFFER,
            IMAGE_BUFFER, INT_IMAGE_BUFFER, UNSIGNED_INT_IMAGE_BUFFER -> GlTextureResourceType.TEXTURE_BUFFER
