package net.typho.big_shot_lib.files
...
abstract class ResourceRegistry<T>(
    ...
    constructor(name: String) : this(BigShotLib.id(name), FileToIdConverter.json("neo/$name"))
    ...
    override fun reload(manager: ResourceManager) {
        ...
        BigShotLib.LOGGER.info("Loaded ${map.size} entries of resource registry $name")
    }
}