...
in vec4 vertexColor;
in vec2 texCoord0;
in vec3 BigShotVertexNormal;

out vec4 fragColor;
out vec3 BigShotFragmentNormal;
out vec4 BigShotFragmentAlbedo;
...
void main() {
    ...
    BigShotFragmentNormal = BigShotVertexNormal;
}
