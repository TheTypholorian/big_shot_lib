...
sealed interface GlScissorShard : GlDrawStateShard {
    data class Enabled(
        ...
        override fun bind(): BoundResource {
            val flag = NeoGlStateManager.MAIN.scissorEnabled.push(true)
            val scissor = NeoGlStateManager.MAIN.scissor.push(scissor)
    ...
    object Disabled : GlScissorShard {
        override fun bind(): BoundResource {
            return NeoGlStateManager.MAIN.scissorEnabled.push(false)
        }
    }
}