...
class NeoRect4d : AbstractRect4<Double> {
    constructor(min: AbstractVec4<Double>, max: AbstractVec4<Double>) : super(min, max)
    ...
    override fun create(min: AbstractVec4<Double>, max: AbstractVec4<Double>) = NeoRect4d(min, max)
}