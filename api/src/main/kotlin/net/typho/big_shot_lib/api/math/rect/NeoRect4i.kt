...
class NeoRect4i : AbstractRect4<Int, NeoRect4i, NeoVec4i> {
    constructor(min: NeoVec4i, max: NeoVec4i) : super(min, max)
    ...
    override fun create(min: NeoVec4i, max: NeoVec4i) = NeoRect4i(min, max)
}