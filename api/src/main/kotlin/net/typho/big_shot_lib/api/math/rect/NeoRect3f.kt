...
class NeoRect3f : AbstractRect3<Float> {
    constructor(min: AbstractVec3<Float>, max: AbstractVec3<Float>) : super(min, max)
    ...
    override fun create(min: AbstractVec3<Float>, max: AbstractVec3<Float>) = NeoRect3f(min, max)
}