...
class NeoRect3d : AbstractRect3<Double> {
    constructor(min: AbstractVec3<Double>, max: AbstractVec3<Double>) : super(min, max)
    ...
    override fun create(min: AbstractVec3<Double>, max: AbstractVec3<Double>) = NeoRect3d(min, max)
}